...
def create_custom_category(name: str, products: list, visible_in_site: bool, image: str):
    """
    Create a custom category for products
    """
    custom_category = CustomCategories(name, products, visible_in_site, image)
...
def edit_custom_category(name: str, new_name: str, products: list, visible_in_site: bool, image: str):
    """
    editing custom category
    """
    result, message = CustomCategories.edit(name, new_name, products, visible_in_site, image)
    if result:
