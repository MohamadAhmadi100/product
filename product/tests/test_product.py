...
def test_get_product(create_and_delete_product_fixture):
    ...
    assert data == {'system_code': '100101030001',
                    'config': {'storage': '64gb', 'color': 'black',
                               'guarantee': 'sherkati', 'ram': '3gb'},
                    'model': 'A022',
                    'brand': 'Mobile Sumsung',
                    'sub_category': 'Mobile',
...
def test_get_all_products(create_and_delete_products_fixture):
    ...
    sample_data = [{'system_code': '100101030001',
                    'config': {'storage': '64gb', 'color': 'black',
                               'guarantee': 'sherkati', 'ram': '3gb'},
                    'model': 'A022',
                    'brand': 'Mobile Sumsung',
                   ...
                   {'system_code': '100101030002',
                    'config': {'storage': '64gb',
                               'color': 'blue', 'guarantee': 'sherkati', 'ram': '3gb'},
                    'model': 'A022',
                    'brand': 'Mobile Sumsung',
                    'sub_category': 'Mobile',
                    'main_category': 'Device'},
                   {'system_code': '100101030003',
                    'config': {'storage': '64gb', 'color': 'white',
                               'guarantee': 'sherkati', 'ram': '3gb'},
                    'model': 'A022',
                    'brand': 'Mobile Sumsung',
                    'sub_category': 'Mobile',
